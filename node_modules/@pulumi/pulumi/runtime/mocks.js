...
class MockMonitor {
    ...
    invoke(req, callback) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const result = this.mocks.call(req.getTok(), rpc_1.deserializeProperties(req.getArgs()), req.getProvider());
    ...
    readResource(req, callback) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                response.setProperties(structproto.Struct.fromJavaScript(yield rpc_1.serializeProperties("", result.state)));
                callback(null, response);
            }
            catch (err) {
                callback(err, undefined);
    ...
    registerResource(req, callback) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                response.setObject(structproto.Struct.fromJavaScript(yield rpc_1.serializeProperties("", result.state)));
                callback(null, response);
            }
            catch (err) {
                callback(err, undefined);
