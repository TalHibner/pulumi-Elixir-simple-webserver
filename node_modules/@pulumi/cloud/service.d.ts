...
export declare type ContainerProtocol = "tcp" | "udp" | "http" | "https";
export interface ContainerVolumeMount {
    containerPath: string;
    sourceVolume: Volume;
}
export declare type VolumeKind = "SharedVolume" | "HostPathVolume";
export declare type Volume = SharedVolume | HostPathVolume;
/**
...
export declare let SharedVolume: SharedVolumeConstructor;
/**
...
export declare let HostPathVolume: HostPathVolumeConstructor;
/**
...
export declare let Service: ServiceConstructor;
/**
...
export declare let Task: TaskConstructor;
