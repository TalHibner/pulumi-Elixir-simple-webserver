 ...
 */
export declare type Action = () => Promise<void>;
/**
 ...
 */
export declare function interval(name: string, options: IntervalRate, handler: Action, opts?: pulumi.ResourceOptions): void;
/**
 ...
 * @param opts A bag of options that controls how this resource behaves.
 */
export declare function cron(name: string, cronTab: string, handler: Action, opts?: pulumi.ResourceOptions): void;
/**
 ...
 * @param opts A bag of options that controls how this resource behaves.
 */
export declare function daily(name: string, handler: Action, opts?: pulumi.ResourceOptions): void;
/**
 ...
 * @param opts A bag of options that controls how this resource behaves.
 */
export declare function daily(name: string, schedule: DailySchedule, handler: Action, opts?: pulumi.ResourceOptions): void;
/**
 ...
 * @param opts A bag of options that controls how this resource behaves.
 */
export declare function hourly(name: string, handler: Action, opts?: pulumi.ResourceOptions): void;
/**
 ...
 * @param opts A bag of options that controls how this resource behaves.
 */
export declare function hourly(name: string, schedule: HourlySchedule, handler: Action, opts?: pulumi.ResourceOptions): void;
