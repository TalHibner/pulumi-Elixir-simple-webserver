...
class Topic extends pulumi.ComponentResource {
    ...
    subscribe(name, handler) {
        ...
        const eventHandler = (ev, context, callback) => {
            Promise.all(ev.Records.map((record) => __awaiter(this, void 0, void 0, function* () {
                yield handler(JSON.parse(record.Sns.Message));
        ...
        const lambda = function_1.createCallbackFunction(subscriptionName, eventHandler, /*isFactoryFunction:*/ false, opts);
